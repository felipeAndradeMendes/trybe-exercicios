...
if __name__ == "__main__":
    ...
    print(linked_list)
    # saída: LinkedList(len=2 value=Node(value=2
    ...
    print(linked_list)  # saída: LinkedList(len=2
    ...
    print(linked_list.get_element_at(3))  # saída:
    # Node(value=8 next=None)

    print(linked_list)
    print("INDEX OF:", linked_list.index_of(6))
    print(linked_list)
