...
list_of_randoms = random.sample(range(10000), 10000)
# print("RANDOM LIST", list_of_randoms)
...
# selection_sort(list_of_randoms)
# insertion_sort(list_of_randoms)
# bubble_sort(list_of_randoms)
# merge_sort(list_of_randoms)
quick_sort(list_of_randoms, 0, len(list_of_randoms) - 1)
