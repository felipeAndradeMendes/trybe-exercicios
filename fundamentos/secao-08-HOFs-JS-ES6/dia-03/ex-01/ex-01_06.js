...
// Testa se atende a condição de ter '.' nas posições 1, 4 e 7 da string
const findInicials = (value) => {
  const book = value.author.name; // nome do livro 
  
  return book[1] === '.' && book[4] === '.' && book[7] === '.'; // posições ondeos ponto deveriam estar
};

// sendo verdadeira a condição da função acima, o find abaixo é satisfeito e retorna o elemento
