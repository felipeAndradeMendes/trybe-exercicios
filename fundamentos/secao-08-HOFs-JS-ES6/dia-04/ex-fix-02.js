...
const personData = {...user, ...jobInfos};
...
const { name, age, nationality, profession, squad, squadInitials } = personData;

const string = `Hi, my name is ${name}, I'm ${age} years old and I'm ${nationality}. I work as a ${profession} and my squad is ${squadInitials}-${squad}`;
